...
$curl_Tranfer2_post_data = [
    ...
    'AccountReference' => 'Auction System Site',
...
try {
	...
	$mail->Password = 'mmeenazuymkkxhxi';						
	$mail->SMTPSecure = 'tls';							
	$mail->Port	 = 587;
	$mail->setFrom("antoninan@kabarak.ac.ke", "Auction System");		
	$mail->addAddress($email);	
	$mail->isHTML(true);								
	$mail->Subject = 'Auction System';
	$mail->Body='Dear '.$name.' Your purchase of '.$itemname.' of KES'.$amount.' with transaction code '.$transaction_code.' has been received.Thankyou ';
